...
public class nivel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mensaje.setText( "Condición en que la densidad de la población se amplía a un límite que provoca un empeoramiento del entorno, una disminución en la calidad de vida, o un desplome de la población");


        bttHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(nivel2.this, home.class);
        ...
        bttCerrar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(nivel2.this, login.class);
                startActivity(intent);
            }
        });
    }
